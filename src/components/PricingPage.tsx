    ...
    <div className="min-h-[calc(100vh-4rem)] bg-[#09090B] py-16 px-4 sm:px-6 selection:bg-[#8B5CF6]/30">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-16">
          ...
          {/* Pro Tier */}
          <div className="bg-[#111113] border-2 border-[#8B5CF6] rounded-3xl p-8 flex flex-col justify-between shadow-2xl relative">
            <div className="absolute -top-3.5 right-6 px-3 py-1 bg-[#8B5CF6] text-white text-[10px] font-mono uppercase font-bold tracking-wider rounded-full shadow-md">
              Most Popular
            </div>
            ...
            <button
              onClick={() => onNavigate('/generate')}
              className="w-full py-3.5 px-4 bg-[#8B5CF6] hover:bg-[#A78BFA] text-white text-xs font-semibold rounded-xl transition-all shadow-lg shadow-[#8B5CF6]/25 flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98]"
            >
